<img src='https://github.com/akiyamasho/cyclegan/raw/master/imgs/horse2zebra.gif' align="right" width=384>
...
**Aviso**: El software actual funciona correctamente en PyTorch 0.41+. Para soporte en PyTorch 0.1-0.3: [branch](https://github.com/akiyamasho/cyclegan/tree/pytorch0.3.1).

Puede encontrar información útil en [training/test tips](https://github.com/akiyamasho/cyclegan/blob/master/docs/tips.md) y [preguntas frecuentes](https://github.com/akiyamasho/cyclegan/blob/master/docs/qa.md). Para implementar modelos y conjuntos de datos personalizados, consulte nuestro [templates](https://github.com/akiyamasho/cyclegan/blob/master/docs/README_es.md#modelo-y-dataset-personalizado). Para ayudar a los usuarios a comprender y adaptar mejor nuestra base de código, proporcionamos un [overview](https://github.com/akiyamasho/cyclegan/blob/master/docs/overview.md) de la estructura de código de este repositorio.
...
<img src='https://github.com/akiyamasho/cyclegan/blob/master/imgs/edges2cats.jpg' width="400px"/>
...
```bash
git clone https://github.com/akiyamasho/cyclegan
...
- Instale [PyTorch](http://pytorch.org) 0.4+ y sus otras dependencias (e.g., torchvision, [visdom](https://github.com/facebookresearch/visdom) y [dominate](https://github.com/Knio/dominate)).
  ...
  - Para uso de Docker, Proporcionamos la imagen Docker y el archivo Docker preconstruidos. Por favor, consulte nuestra página
    [Docker](https://github.com/akiyamasho/cyclegan/blob/master/docs/docker.md).
...
- Para entrenar y probar modelos de colorización basados en pix2pix, agregue la linea `--model colorization` y `--dataset_mode colorization`. Para más detalles de nuestro entrenamiento [tips](https://github.com/akiyamasho/cyclegan/blob/master/docs/tips.md#notes-on-colorization).
...
- El modelo pre-entrenado se guarda en `./checkpoints/{name}_pretrained/latest_net_G.pth`. Revise [aqui](https://github.com/akiyamasho/cyclegan/blob/master/scripts/download_cyclegan_model.sh#L3) para todos los modelos CycleGAN disponibles.
...
- Revise [aqui](https://github.com/akiyamasho/cyclegan/blob/master/scripts/download_pix2pix_model.sh#L3) para todos los modelos pix2pix disponibles. Por ejemplo, si desea descargar el modelo label2photo en el dataset:
...
Proporcionamos la imagen Docker y el archivo Docker preconstruidos que pueden ejecutar este repositorio de código. Ver [docker](https://github.com/akiyamasho/cyclegan/blob/master/docs/docker.md).

## [Datasets](https://github.com/akiyamasho/cyclegan/blob/master/docs/datasets.md)

Descargue los conjuntos de datos pix2pix / CycleGAN y cree sus propios conjuntos de datos.

## [Entretanimiento/Test Tips](https://github.com/akiyamasho/cyclegan/blob/master/docs/tips.md)

Las mejores prácticas para entrenar y probar sus modelos.

## [Preguntas frecuentes](https://github.com/akiyamasho/cyclegan/blob/master/docs/qa.md)
...
Si planea implementar modelos y conjuntos de datos personalizados para sus nuevas aplicaciones, proporcionamos un conjunto de datos [template](https://github.com/akiyamasho/cyclegan/blob/master/data/template_dataset.py) y un modelo [template](https://github.com/akiyamasho/cyclegan/blob/master/models/template_model.py) como punto de partida.

## [Estructura de codigo](https://github.com/akiyamasho/cyclegan/blob/master/docs/overview.md)
...
Por favor ejecute `flake8 --ignore E501 .` y `python ./scripts/test_before_push.py` antes de realizar un Pull en el código, asegure de también actualizar la estructura del código [overview](https://github.com/akiyamasho/cyclegan/blob/master/docs/overview.md) en consecuencia si agrega o elimina archivos.
