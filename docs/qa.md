...
#### NotSupportedError ([#829](https://github.com/akiyamasho/cyclegan/issues/829))
...
#### Experiment details (e.g., BW->color) ([#306](https://github.com/akiyamasho/cyclegan/issues/306))
