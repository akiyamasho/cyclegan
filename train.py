...
See training and test tips at: https://github.com/akiyamasho/cyclegan/blob/master/docs/tips.md
See frequently asked questions at: https://github.com/akiyamasho/cyclegan/blob/master/docs/qa.md
"""
import time
import os
import torch
...
if __name__ == "__main__":
    ...
    web_dir = os.path.join(
        val_opts.results_dir,
        val_opts.name,
        "{}_{}".format(val_opts.phase, val_opts.epoch),
    ...
    for epoch in range(
        ...
        if epoch % opt.val_metric_freq == 0:
            print(
                "Evaluating FID for validation set at epoch %d, iters %d, at dataset %s"
            ...
            for i, data in enumerate(val_dataset):
                ...
                save_images(
                    ...
                    visuals,
                    img_path,
                    aspect_ratio=val_opts.aspect_ratio,
